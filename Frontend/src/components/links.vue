  ...
  <div id="parent" :class="showpopup ? 'blur' : ''">
    <div class="container  position-relative">
      ...
      <div class="d-flex gap-2 back-div pointer" @click="back">
        <Icon icon="ep:back" class="responsive d-none" width="20" height="25" />
        <Icon icon="ep:back" class="none-responsive" width="25" height="25" />

        <span>Back</span>
      </div>
      <div class="none-responsive">
      ...
      <div class="responsive d-none mt-5">
